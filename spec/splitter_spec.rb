  ...
  describe "Split a project" do                      
    describe "every 10 lines" do 
      context "from a square image" do 
        let(:project) { {name:'Pov', partial_images:[], id:1000, options:{height:50, width:50, scene:'blabla'}, image:''} }        
        it "should be splited" do
      ...
      context "from a rectangular image, big width" do
        let(:project) { {name:'Pov', partial_images:[], id:1000, options:{height:50, width:100, scene:'blabla'}, image:''} }
        it "should be splited" do
          tasks, project2 = DPovray::Splitter.split_project_in_many_tasks(project)
      ...
      context "from a rectangular image, big height" do
        let(:project) { {name:'Pov', partial_images:[], id:1000, options:{height:100, width:50, scene:'blabla'}, image:''} }
        it "should be splited" do
          tasks, project2 = DPovray::Splitter.split_project_in_many_tasks(project)
